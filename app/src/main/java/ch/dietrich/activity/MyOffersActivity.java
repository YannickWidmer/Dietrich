...
public class MyOffersActivity extends ActionBarActivity implements AsyncTaskCompleteListener<List<OfferListItem>>{
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_alloffers:
			Intent i = new Intent(MyOffersActivity.this,
	...
	protected void onResume() {
		...
		pDialog = new ProgressDialog(MyOffersActivity.this);
		...
		SharedPreferences sp = PreferenceManager
				.getDefaultSharedPreferences(MyOffersActivity.this);
		String apiKey = sp.getString("apiKey", "");
		
		offertDAO.getOffers(apiKey, this);
	}

	public void addOffer(View v) {
		Intent i = new Intent(MyOffersActivity.this, AddOfferActivity.class);
		startActivity(i);
	}
	...
	private void updateList() {
		...
		listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(MyOffersActivity.this,
